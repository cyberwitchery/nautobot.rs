...
pub struct PatchedBulkWritableLocationRequest {
    #[serde(rename = "id")]
    pub id: uuid::Uuid,
    #[serde(
        rename = "time_zone",
    ...
    pub location_type: Option<Box<crate::models::BulkWritableCableRequestStatus>>,
...
impl PatchedBulkWritableLocationRequest {
    /// Add a `tree_depth` field to non-nested model serializers based on django-tree-queries.
    pub fn new(id: uuid::Uuid) -> PatchedBulkWritableLocationRequest {
