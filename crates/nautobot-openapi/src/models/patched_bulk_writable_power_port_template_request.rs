...
pub struct PatchedBulkWritablePowerPortTemplateRequest {
    #[serde(rename = "id")]
    pub id: uuid::Uuid,
...
impl PatchedBulkWritablePowerPortTemplateRequest {
    /// Base class to use for serializers based on OrganizationalModel or PrimaryModel.  Can also be used for models derived from BaseModel, so long as they support custom fields, notes, and relationships.
    pub fn new(id: uuid::Uuid) -> PatchedBulkWritablePowerPortTemplateRequest {
