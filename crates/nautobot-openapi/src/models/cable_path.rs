...
pub struct CablePath {
    ...
    #[serde(rename = "peer_connector", skip_serializing_if = "Option::is_none")]
    pub peer_connector: Option<i32>,
    #[serde(rename = "origin_fans_out", skip_serializing_if = "Option::is_none")]
    pub origin_fans_out: Option<bool>,
    #[serde(
        rename = "destination_fans_out",
        skip_serializing_if = "Option::is_none"
    )]
    pub destination_fans_out: Option<bool>,
}
...
impl CablePath {
    pub fn new(origin_id: uuid::Uuid) -> CablePath {
        CablePath {
            ...
            is_split: None,
            peer_connector: None,
            origin_fans_out: None,
            destination_fans_out: None,
        }
    }
}
