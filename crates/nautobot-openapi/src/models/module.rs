...
pub struct Module {
    ...
    pub module_type: Box<crate::models::ApprovalWorkflowStageResponseApprovalWorkflowStage>,
    #[serde(
...
impl Module {
    ...
    pub fn new(
        module_type: crate::models::ApprovalWorkflowStageResponseApprovalWorkflowStage,
