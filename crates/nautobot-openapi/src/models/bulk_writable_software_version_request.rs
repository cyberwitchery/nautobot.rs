...
pub struct BulkWritableSoftwareVersionRequest {
    ...
    pub platform: Box<crate::models::ApprovalWorkflowStageResponseApprovalWorkflowStage>,
    #[serde(rename = "status")]
...
impl BulkWritableSoftwareVersionRequest {
    ...
    pub fn new(
        id: uuid::Uuid,
        version: String,
        platform: crate::models::ApprovalWorkflowStageResponseApprovalWorkflowStage,
