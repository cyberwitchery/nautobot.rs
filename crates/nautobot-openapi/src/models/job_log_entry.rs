...
pub struct JobLogEntry {
    ...
    pub job_result: Box<crate::models::ApprovalWorkflowStageResponseApprovalWorkflowStage>,
...
impl JobLogEntry {
    ...
    pub fn new(
        job_result: crate::models::ApprovalWorkflowStageResponseApprovalWorkflowStage,
    ) -> JobLogEntry {
        JobLogEntry {
            id: None,
            object_type: None,
