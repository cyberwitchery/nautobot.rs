...
pub enum ObjectMetadataAssignedObject {
    ...
    #[serde(rename = "dcim.cabletocabletermination")]
    NestedCableToCableTermination {
        #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
        id: Option<uuid::Uuid>,
        #[serde(rename = "url", skip_serializing_if = "Option::is_none")]
        url: Option<String>,
    },
    #[serde(rename = "dcim.cabletype")]
    NestedCableType {
        #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
        id: Option<uuid::Uuid>,
        #[serde(rename = "url", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "extras.approvalworkflowstageresponse")]
    ...
    #[serde(rename = "ipam.ipaddressrange")]
