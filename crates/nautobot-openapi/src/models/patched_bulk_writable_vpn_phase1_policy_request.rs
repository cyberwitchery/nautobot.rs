...
pub struct PatchedBulkWritableVpnPhase1PolicyRequest {
    #[serde(rename = "id")]
    pub id: uuid::Uuid,
    #[serde(
...
impl PatchedBulkWritableVpnPhase1PolicyRequest {
    /// VPNPhase1Policy Serializer.
    pub fn new(id: uuid::Uuid) -> PatchedBulkWritableVpnPhase1PolicyRequest {
