...
pub struct PatchedBulkWritableConfigContextRequest {
    #[serde(rename = "id")]
    pub id: uuid::Uuid,
    #[serde(
    ...
    pub device_families: Option<Vec<crate::models::BulkWritableCableRequestStatus>>,
    #[serde(rename = "tags", skip_serializing_if = "Option::is_none")]
    pub tags: Option<Vec<crate::models::BulkWritableCableRequestStatus>>,
}

impl PatchedBulkWritableConfigContextRequest {
    /// Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during validation. (DRF does not do this by default; see <https://github.com/encode/django-rest-framework/issues/3144>)
    pub fn new(id: uuid::Uuid) -> PatchedBulkWritableConfigContextRequest {
