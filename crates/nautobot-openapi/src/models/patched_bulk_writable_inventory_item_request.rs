...
pub struct PatchedBulkWritableInventoryItemRequest {
    #[serde(rename = "id")]
    pub id: uuid::Uuid,
...
impl PatchedBulkWritableInventoryItemRequest {
    /// Add a `tree_depth` field to non-nested model serializers based on django-tree-queries.
    pub fn new(id: uuid::Uuid) -> PatchedBulkWritableInventoryItemRequest {
