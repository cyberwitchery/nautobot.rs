...
pub struct User {
    ...
    /// User specific default saved views
    #[serde(
        rename = "default_saved_views",
        skip_serializing_if = "Option::is_none"
    )]
    pub default_saved_views: Option<Vec<crate::models::UserSpecificDefaultSavedViews>>,
}
