...
pub async fn ipam_ip_addresses_list(
    ...
    if let Some(ref local_var_str) = prefix_exact {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("prefix_exact".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "prefix_exact",
...
pub async fn ipam_prefixes_list(
    ...
    if let Some(ref local_var_str) = ancestors {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("ancestors".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "ancestors",
    ...
    if let Some(ref local_var_str) = max_depth {
        local_var_req_builder =
            local_var_req_builder.query(&[("max_depth", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = namespace {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
    ...
    if let Some(ref local_var_str) = prefix_and_descendants {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("prefix_and_descendants".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
    ...
    if let Some(ref local_var_str) = vpn_tunnel_endpoints {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("vpn_tunnel_endpoints".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
    ...
    if let Some(ref local_var_str) = vpn_tunnel_endpoints__isnull {
        local_var_req_builder = local_var_req_builder
            .query(&[("vpn_tunnel_endpoints__isnull", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = vpn_tunnel_endpoints__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("vpn_tunnel_endpoints__n".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "vpn_tunnel_endpoints__n",
                &local_var_str
                    .into_iter()
                    .map(|p| p.to_string())
                    .collect::<Vec<String>>()
    ...
    if let Some(ref local_var_str) = vpn_tunnel_endpoints_name_contains {
