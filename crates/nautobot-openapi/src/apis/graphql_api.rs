...
#[serde(untagged)]
pub enum GraphqlCreateError {
    Status400(crate::models::GraphqlCreate400Response),
...
pub async fn graphql_create(
    ...
    local_var_req_builder = local_var_req_builder.json(&graph_qlapi_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GraphqlCreateError> =
