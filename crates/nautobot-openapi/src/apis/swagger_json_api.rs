...
/// struct for passing parameters to the method [`swagger_period_json_retrieve`]
#[derive(Clone, Debug, Default)]
pub struct SwaggerPeriodJsonRetrieveParams {
...
/// struct for typed errors of method [`swagger_period_json_retrieve`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SwaggerPeriodJsonRetrieveError {
    UnknownValue(serde_json::Value),
}

/// OpenApi3 schema for this API. Format can be selected via content negotiation.  - YAML: application/vnd.oai.openapi - JSON: application/vnd.oai.openapi+json
pub async fn swagger_period_json_retrieve(
    configuration: &configuration::Configuration,
    params: SwaggerPeriodJsonRetrieveParams,
) -> Result<
    ::std::collections::HashMap<String, serde_json::Value>,
    Error<SwaggerPeriodJsonRetrieveError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SwaggerPeriodJsonRetrieveError> =
