...
/// struct for typed errors of method [`metrics_retrieve`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MetricsRetrieveError {
...
pub async fn metrics_retrieve(
    configuration: &configuration::Configuration,
) -> Result<(), Error<MetricsRetrieveError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MetricsRetrieveError> =
