...
**failover_strategy** | Option<[**crate::models::BulkWritableDeviceRedundancyGroupRequestFailoverStrategy**](BulkWritableDeviceRedundancyGroupRequest_failover_strategy.md)> |  | [optional]
**name** | **String** |  | 
