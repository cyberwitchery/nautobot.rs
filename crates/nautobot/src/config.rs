...
/// configuration for the nautobot client
#[derive(Clone)]
pub struct ClientConfig {
    /// original base url input
    pub(crate) raw_base_url: String,

    /// base url of the nautobot instance (e.g., "<https://nautobot.example.com>")
...
impl ClientConfig {
    ...
    /// # Arguments
    ///
    /// * `base_url` - The base url of the nautobot instance (with or without trailing slash)
    ...
    ///
    /// let config = ClientConfig::new("https://nautobot.example.com", "your-token-here");
    /// ```
...
mod tests {
    ...
    fn test_validation() {
        ...
        let empty_token = ClientConfig::new("https://nautobot.example.com", "");
